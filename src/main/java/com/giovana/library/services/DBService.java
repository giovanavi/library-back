...
public class DBService {
    ...
    public void initDataBase() {
        ...
        Livro livro1 = new Livro(null, "45612", "HP1", "Hermione Granger", "Rocco", "Infantojuvenil", true);
        Livro livro2 = new Livro(null, "12345", "HP2", "Hermione Granger", "Rocco", "Infantojuvenil", true);
        Livro livro3 = new Livro(null, "78945", "HP3", "Hermione Granger", "Rocco", "Infantojuvenil", true);
        Livro livro4 = new Livro(null, "45784", "HP4", "Hermione Granger", "Rocco", "Infantojuvenil", true);
        Livro livro5 = new Livro(null, "12548", "HP5", "Hermione Granger", "Rocco", "Infantojuvenil", true);
        Livro livro6 = new Livro(null, "63254", "HP6", "Hermione Granger", "Rocco", "Infantojuvenil", true);
        Livro livro7 = new Livro(null, "58796", "HP7", "Hermione Granger", "Rocco", "Infantojuvenil", true);
        ...
        Emprestimo emprestimo3 = new Emprestimo(null, "28/1/2023", "11/2/2023", usuario3, livro3);
